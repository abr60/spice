...
Item {
  ...
  readonly property string downloadScript: Quickshell.env("HOME") + "/.config/omarchy/plugins/quran/download.sh"
  readonly property string cacheScript: Quickshell.env("HOME") + "/.config/omarchy/plugins/quran/cache.sh"
  readonly property string validateScript: Quickshell.env("HOME") + "/.config/omarchy/plugins/quran/validate_media.sh"
