...
`~/.config/omarchy/plugins/bar-autohide`, validates it, and enables the
service in the shell configuration.

## Update

```bash
omarchy plugin update bar-autohide
```

## Disable

```bash
omarchy plugin disable bar-autohide
```
...
```bash
omarchy plugin remove bar-autohide
```
