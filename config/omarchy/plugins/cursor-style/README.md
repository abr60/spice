...
omarchy plugin enable cursor-style
```
...
```sh
omarchy plugin remove cursor-style --yes
```
...
```sh
omarchy-shell shell toggle cursor-style
```
...
```
manifest.json       plugin manifest (id cursor-style, overlay)
