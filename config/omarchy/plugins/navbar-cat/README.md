...
git clone https://github.com/tallsam/omarchy-navbar-cat.git \
  ~/.config/omarchy/plugins/navbar-cat
omarchy-shell shell rescanPlugins
omarchy plugin enable navbar-cat
```
...
```bash
omarchy plugin remove navbar-cat
```

Or by hand:

```bash
omarchy plugin disable navbar-cat
rm -rf ~/.config/omarchy/plugins/navbar-cat
omarchy-shell shell rescanPlugins
```
